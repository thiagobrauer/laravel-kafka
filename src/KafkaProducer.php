...
class KafkaProducer
{
    ...
    public function __construct(Conf $conf = null)
    {
        if(!$conf) {
            ...
            $conf->set('bootstrap.servers', config('laravel_kafka.producer.servers'));

            $conf->set('compression.type', config('laravel_kafka.producer.compression'));

            if (config('laravel_kafka.producer.debug')) {
